...
class PhotoGroup(models.Model):
    ...
    cover = models.ImageField(upload_to=PathAndRename("photocover"), blank=True, verbose_name=u'封面')
...
class Photo(models.Model):
    ...
    photo = models.ImageField(upload_to=PathAndRename("photo"), blank=True, verbose_name=u'照片')
